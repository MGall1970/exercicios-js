...
const d1 = new Date(0) // é um objeto data
const d2 = new Date(0) // é um objeto data
console.log( '09.', d1, '==', d2, d1 == d2 ) // é a referência de memória
console.log( '10.', d1, '===', d2, d1 === d2 ) // é a referência de memória
